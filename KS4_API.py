...
DATA_DIRECTORY = Path('C:/Users/ZYH/Desktop')  # NOTE: You should change this
# Create path if it doesn't exist
DATA_DIRECTORY.mkdir(parents=True, exist_ok=True)

# Specify path to your existing data
# NOTE: You must change this
filepath = Path("C:/Users/ZYH/Desktop/file_spec_3_0.ns6")
...
probe_path = r"C:\Users\ZYH\.kilosort\probes\UFE64.json"
...
ops, st, clu, tF, Wall, similar_templates, is_ref, \
    est_contam_rate, kept_spikes = run_kilosort(
        ...
        filename=r'C:\Alldata\test_data\ZFM-02370_mini.imec0.ap.short.bin',
        data_dir=None,
        file_object=None,
        results_dir=None,
        data_dtype=np.int16,
